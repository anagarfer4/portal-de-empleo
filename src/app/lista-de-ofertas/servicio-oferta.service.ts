...
export class ServicioOfertaService {
  private ofertas: Array<Oferta> = [
    ...
    'http://www.infojobs.net/logo/logo/do-get.xhtml?id=22313713628&dgv=8640945448931150180', 'TICTUM, Innovación y Tecnología, S.L','2017-05-10', 'Madrid, España', 'Jornada completa', '#', ''),
    ...
    'https://d1ewohb620cza6.cloudfront.net/user_s3_avatar_96x96/avatars/000/455/620/455620-original.jpeg?1482309556', 'RitaWanda', '2017-05-10', 'Madrid, España', 'Jornada parcial', '#', ''),
    new Oferta('Front-end Developer', 'Turijobs es el portal de empleo especializado en Turismo y Hostelería líder en España. Por ello, las mejores empresas del sector buscan nuestro apo...','https://pbs.twimg.com/profile_images/728546380503916544/Moe-prkM.jpg', 'Turijobs','2017-05-09', 'Barcelona, España', 'tiempo completo', '#', ''),
    new Oferta('Desarrollador Front End', 'En inMediaStudio buscamos personas que quieran formar parte un equipo que disfruta con la tecnología, y cuyo objetivo principal es trabajar por y p...', 'https://d1ewohb620cza6.cloudfront.net/job_cover_xs/job-covers/000/049/165/49165-original.jpg?1492430671', 'InMediaStudio Comunicación, S.L.', '2017-05-08', 'Alcobendas, España', 'Jornada completa', '#', ''),
    ...
    'http://www.infojobs.net/logo/logo/do-get.xhtml?id=17035424534&dgv=2545832607573629202', 'Simumak', '2017-05-06', 'Madrid, España', 'Jornada completa', '#', ''),
    ...
    'https://d1ewohb620cza6.cloudfront.net/user_s3_avatar_126x96/avatars/000/060/193/60193-original.jpg?1385034511', 'BABEL Sistemas de Información', '2017-05-04', 'Málaga, España', 'Jornada parcial', '#', ''),
    ...
    'http://cdn.iphonehacks.com/wp-content/uploads/2013/10/samsung-logo.jpg', 'Samsung', '2017-05-03', 'Valencia, España', 'Jornada completa', '#', ''),
