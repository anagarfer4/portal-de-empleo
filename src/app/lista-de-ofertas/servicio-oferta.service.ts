...
export class ServicioOfertaService {
  private ofertas: Array<Oferta> = [
    ...
    'http://www.infojobs.net/logo/logo/do-get.xhtml?id=22313713628&dgv=8640945448931150180', 'TICTUM, Innovación y Tecnología, S.L', new Date('10/05/2017'), 'Madrid, España', 'Jornada completa'),
    new Oferta('Becario Marketing Digital - Prácticas', 'Right Design Agency (RDA) es un equipo multidisciplinar compuesto por arquitectos, interioristas, diseñadores y gestores inmobiliarios y de comunic...', 'https://d1ewohb620cza6.cloudfront.net/job_cover_xs/job-covers/000/049/631/49631-original.jpg?1493811169', 'Right Design Agency', new Date('10/05/2017'), 'Madrid, España', 'Jornada completa'),
    ...
    'https://d1ewohb620cza6.cloudfront.net/user_s3_avatar_96x96/avatars/000/455/620/455620-original.jpeg?1482309556', 'RitaWanda', new Date ('09/05/2017'), 'Madrid, España', 'Jornada parcial'),
    new Oferta('Front-end Developer', 'Turijobs es el portal de empleo especializado en Turismo y Hostelería líder en España. Por ello, las mejores empresas del sector buscan nuestro apo...','https://pbs.twimg.com/profile_images/728546380503916544/Moe-prkM.jpg', 'Turijobs', new Date ('09/05/2017'), 'Barcelona, España', 'tiempo completo'),
    new Oferta('Desarrollador Front End', 'En inMediaStudio buscamos personas que quieran formar parte un equipo que disfruta con la tecnología, y cuyo objetivo principal es trabajar por y p...', 'https://d1ewohb620cza6.cloudfront.net/job_cover_xs/job-covers/000/049/165/49165-original.jpg?1492430671', 'InMediaStudio Comunicación, S.L.', new Date ('08/05/2017'), 'Alcobendas, España', 'Jornada completa'),
    ...
    'http://www.infojobs.net/logo/logo/do-get.xhtml?id=17035424534&dgv=2545832607573629202', 'Simumak', new Date ('06/05/2017'), 'Madrid, España', 'Jornada completa'),
    ...
    'https://d1ewohb620cza6.cloudfront.net/user_s3_avatar_126x96/avatars/000/060/193/60193-original.jpg?1385034511', 'BABEL Sistemas de Información', new Date ('04/05/2017'), 'Málaga, España', 'Jornada parcial'),
